...
parcels = gpd.read_file('data/processed/cook_county_parcels_raw.geojson')
...
# Save
joined.to_file('data/processed/cook_county_parcels_final.geojson', driver='GeoJSON')
print("\nSaved to data/processed/cook_county_parcels_final.geojson")

# Check file size
size_mb = os.path.getsize('data/processed/cook_county_parcels_final.geojson') / (1024*1024)
